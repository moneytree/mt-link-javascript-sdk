...
All functions which open or construct a URL and accept `email` in their arguments are now `async`. This was necessary because they now need to make an asynchronous API call to exchange the `email` for an `emailToken` to include in the constructed URL rather than `email`.

This change allows us to remove the `email` param from all URLs generated by the SDK, removing the risk of user emails being exposed in logs/browser history.

* Add `await` as required in sample app ([289e2aa](https://github.com/moneytree/mt-link-javascript-sdk/commit/289e2aa))
* Add `fetchEmailToken` private helper ([38cd835](https://github.com/moneytree/mt-link-javascript-sdk/commit/38cd835))
* Add documentation for `async` changes ([302d75f](https://github.com/moneytree/mt-link-javascript-sdk/commit/302d75f))
* Add missing async for tests from other PR ([b9edf73](https://github.com/moneytree/mt-link-javascript-sdk/commit/b9edf73))
* Add optional `emailToken` to private params ([c35ad8a](https://github.com/moneytree/mt-link-javascript-sdk/commit/c35ad8a))
* Bump sample app to yarn 4 and use portal protocol ([9247d56](https://github.com/moneytree/mt-link-javascript-sdk/commit/9247d56))
* Make functions async as necessary ([ca78d47](https://github.com/moneytree/mt-link-javascript-sdk/commit/ca78d47))
* Test generateConfigs emailToken handling directly ([e1062af](https://github.com/moneytree/mt-link-javascript-sdk/commit/e1062af))
* Use correct endpoint format ([2787220](https://github.com/moneytree/mt-link-javascript-sdk/commit/2787220))
