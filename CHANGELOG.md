...
* chore(docs): deduplicate changelog entries ([8e27010](https://github.com/moneytree/mt-link-javascript-sdk/commit/8e27010))
* chore(docs): update for 'otp' as valid `authn_method` ([cf0508f](https://github.com/moneytree/mt-link-javascript-sdk/commit/cf0508f))
* chore(release): bump to version 4.3.0 :tada: ([cf1acd7](https://github.com/moneytree/mt-link-javascript-sdk/commit/cf1acd7))
